<?php
//scans/MWEScan/2013/web/webtc/getword.php
//ejf 07-02-2013
...
// not for mwe $keyin1 = preprocess_unicode_input($keyin,$filterin);
// not for mwe $key = transcoder_processString($keyin1,$filterin,"slp1");
$key = $keyin ; // for MWE: key is in english
