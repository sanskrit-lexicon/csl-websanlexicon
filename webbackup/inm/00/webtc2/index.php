...
<div id="querydiv">
 <div id="dictid"> 
	...
	style="background-color:#DBE4ED">
     ...
     <span id="title">Index to the Names in the Mahabharata</span>
 </div>
...
<td>
    ...
    &nbsp;&nbsp;
    <a href="/php/correction_form.php?dict=INM" target="Corrections">Corrections</a>
