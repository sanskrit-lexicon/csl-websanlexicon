  ...
  var url =  "getword.php" +  
   ...
   "&transLit=" + escape(transLit);
	...
	error:function(jqXHR, textStatus, errorThrown) {
	    alert("Error from getword : " + textStatus + ", errorThrown=" +errorThrown);
	}
    });
...
// Called by a link made by disp.php
 var url1 = '../sqlite/'+url+'#'+anchor;
 win_ls = window.open(url1,
    "winls", "width=920,height=210,scrollbars=yes");
 win_ls.focus();
}
