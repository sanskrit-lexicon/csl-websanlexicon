<?php
////scans/SKDScan/2013/web/webtc1/listhier.php
//ejf May 28, 2013
...
$recarr = dal_skd3($key); // records LIKE key%
$matches=array();
$nmatches=0;
$keylen = strlen($key);
$more=true;
