...
// Dec 14, 2017  pwg specific. (adapted from stc version)
    ...
    02-21-2018. bor.  Changes to "div" in stdhndl and 
                in line_adjust to make first word bold in divs.
    03-13-2018. Same as for mwe
*/
 ...
 */
 ...
 /* bor" Put bold tag around first word of <div n="1"> or <div n="I"> 
 ...
 */
  ...
  $line = preg_replace('|<div n="([1I])">([^ ]*)|', '<div n="\1"><b>\2</b>',
                       $line);
...
function sthndl($xp,$el,$attribs) {
 ...
 global $parentEl;
   ...
   */
   ...
   $row .= "<br/>";   
   */
   // for bor. Preserve line breaks
   if ($n == "lb") {  // otherwise, no change
    $row .= "<br/>";   
   }
