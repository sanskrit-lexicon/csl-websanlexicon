...
<?php
// servepdf.php: 
// 04-17-2018. Use Cologne server for source of image files.
// This is dictionary specific.
// For now, we set $dir explicitly
$dir = "http://www.sanskrit-lexicon.uni-koeln.de/scans/MWScan/2014/web/pdfpages";
$page = $_GET['page'] ;
if (!$page) {$page = $argv[1];}
...
function getfiles($pagestr_in) {
 ...
 if (!$ncur) {
  $pagenum = sprintf('%04d',intval($pagestr_in));
  $pagestr = "$pagenum";
