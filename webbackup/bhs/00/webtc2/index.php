...
<div id="querydiv">
 <div id="dictid"> 
	...
	style="background-color:#DBE4ED">
     ...
     <span id="title">Edgerton Buddhist Hybrid Sanskrit Dictionary</span>
 </div>
...
<td>
    ...
    &nbsp;&nbsp;
    <a href="/php/correction_form.php?dict=BHS" target="Corrections">Corrections</a>
