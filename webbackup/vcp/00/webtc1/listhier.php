<?php
////scans/VCPScan/2013/web/webtc1/listhier.php
//ejf Jan 9, 2014
...
$recarr = dal_vcp3($key); // records LIKE key%
$matches=array();
$nmatches=0;
$keylen = strlen($key);
$more=true;
