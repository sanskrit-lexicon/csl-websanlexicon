...
<div id="querydiv">
 <div id="dictid"> 
	...
	style="background-color:#DBE4ED">
     ...
     <span id="title">Shabda-Sagara Sanskrit-English Dictionary</span>
 </div>
...
<td>
    ...
    &nbsp;&nbsp;
    <a href="/php/correction_form.php?dict=SHS" target="Corrections">Corrections</a>
