...
<div id="querydiv">
 <div id="dictid"> 
	...
	style="background-color:#DBE4ED">
     ...
     <span id="title">Burnouf Dictionnaire Sanscrit-Français</span>
 </div>
...
<td>
    ...
    &nbsp;&nbsp;
    <a href="/php/correction_form.php?dict=BUR" target="Corrections">Corrections</a>
