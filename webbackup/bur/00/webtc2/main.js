// /afs/rrz.uni-koeln.de/vol/www/projekt/sanskrit-lexicon/http/docs/scans/BURScan/2013/web/webtc2/main.js
// June 5, 2013
...
//  var filterdir = document.getElementById("filterdir").value;
  ...
  var url = "query.php" +
   "?word=" +escape(word) + 
   "&lastLnum=" + escape(lastLnum) +
   "&max=" +escape(max) +
   "&filter=" +escape(filter) +
   // "&dictionary=" +escape(dictionary) +
   "&regexp=" + escape(regexp) +
   "&scase=" + escape(scase) +
   "&sword=" + escape(document.getElementById("sword").value) +
   "&sregexp=" + escape(document.getElementById("sregexp").value) +
   "&transLit=" + escape(document.getElementById("transLit").value) +
   "&outopt=" + escape(outopt);
...
//  var url = "/cgi-bin/mwupdate/util.pl";
  ...
  var sendData = "data=" + escape(data)+
   "&utilchoice="+escape(utilchoice) +
   "&filter=" +escape(filter);
...
function displayDB(data) {
  ...
  // Apr 5, 2017. escape(data) was causing problems. Removal seems
  //  to fix problem.  Not sure when escaping is required.
  //var sendData = "data=" + escape(data)+"&filter=" +escape(filter);
  var sendData = "data=" + data+"&filter=" +escape(filter);
    jQuery.ajax({
	url:url,
	type:"POST",
 	data:sendData,
