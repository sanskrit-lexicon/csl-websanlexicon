...
function list1b($key) {
// first  partial match
$recarr = dal_ap903($key); // records LIKE key%
$matches=array();
$nmatches=0;
$keylen = strlen($key);
$more=true;
