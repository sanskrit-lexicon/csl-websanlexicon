<?php
// modified Nov 27, 2012 for consistencey with mwquery.js
// modified June 16, 2013 to allow search for sanskrit words in body of text
$dbg = FALSE;
//include("../monier/monierdisp.php");
