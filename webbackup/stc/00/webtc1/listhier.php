<?php
////scans/STCScan/2013/web/webtc1/listhier.php
//ejf May 28, 2013
...
$recarr = dal_stc3($key); // records LIKE key%
$matches=array();
$nmatches=0;
$keylen = strlen($key);
$more=true;
