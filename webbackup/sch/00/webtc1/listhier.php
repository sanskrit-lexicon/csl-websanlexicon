<?php
////scans/SCHScan/2014/web/webtc1/listhier.php
//ejf Mar 19, 2014
...
$recarr = dal_sch3($key); // records LIKE key%
$matches=array();
$nmatches=0;
$keylen = strlen($key);
$more=true;
