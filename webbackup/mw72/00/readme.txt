readme.txt for mw72web download.  
May 18, 2014
Jim Funderburk
...
a user to install on a local computer a web-browser display of mw72 data.

unzip the mw72web.zip archive. This creates a folder called 'web'.
Rename 'web' to something such as 'mw72'.
...
Move the 'mw72' folder to the 'htdocs' subfolder of your Apache installation.
...
Then, use the url <home>/mw72/ to get the home page of the mw72 displays;
for instance, http://127.0.0.1:4001/mw72/.

For server2go, you may need to slightly adjust the pms_config.ini file to
the one contained in the server2go subdirectory of this mw72web download.


For Mac installation, move the mw72 folder to the Sites folder, and make 
sure web sharing is turned on.
You may need to changed the permissions on the mw72 
folder and its subfolders and directories; e.g., in a terminal, change to
the Sites folder and 'chmod -RE 0777 mw72'. (you may need to use sudo,
e.g., 'sudo chmod -RE 0777 mw72').
