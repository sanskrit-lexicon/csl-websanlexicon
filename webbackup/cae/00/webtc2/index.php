...
<div id="querydiv">
 <div id="dictid"> 
	...
	style="background-color:#DBE4ED">
     ...
     <span id="title">Cappeller Sanskrit-English Dictionary</span>
 </div>
...
<td>
    ...
    &nbsp;&nbsp;
    <a href="/php/correction_form.php?dict=CAE" target="Corrections">Corrections</a>
