...
- [x] **Wave 2 (agent-doable):** convert Semgrep to a blocking `semgrep ci` gate on
      new findings — done via [PR #77](https://github.com/sanskrit-lexicon/csl-websanlexicon/pull/77),
      verified with throwaway PR #79.
