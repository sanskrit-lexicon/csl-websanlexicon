...
(4 MG rulings D1–D4, 03-07-2026). Wave 1 shipped this session (PR #76). Next:

- [ ] **Wave 2 (agent-doable, [H086](https://github.com/gasyoun/Uprava/blob/main/handoffs/H086_websanlexicon_w2_semgrep_gate.md)):**
      convert Semgrep to a blocking `semgrep ci` gate on new findings. Start line:
      `Read C:\Users\user\Documents\GitHub\Uprava\handoffs\H086_websanlexicon_w2_semgrep_gate.md and execute it.`
- [ ] **Wave 2 (MG admin @DO):** turn on `main` branch protection with the SAST + lint
      checks required (mirrored to Uprava GTD).
